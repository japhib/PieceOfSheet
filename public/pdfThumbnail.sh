...
gs -q -o $(basename "${infile}")_p%04d.jpeg -sDEVICE=jpeg "${infile}" -dFirstPage=1 -dLastPage=1

# To get thumbnail JPEGs with a width 200 pixel use the following command:
# gs -q -o name_200px_p%04d.jpg -sDEVICE=jpeg -dPDFFitPage -g200x400 "${infile}" -dFirstPage=1 -dLastPage=1
